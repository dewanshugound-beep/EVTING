...
function StatPill({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col items-center justify-center p-3 rounded-xl bg-zinc-800/60 border border-zinc-700/50">
      ...
      <span className="text-[10px] font-bold text-zinc-500 tracking-widest uppercase mt-0.5 font-mono">
        {label}
      </span>
    </div>
  );
    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 mb-8 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-xs font-black tracking-widest uppercase font-mono"
        >
        ...
        >
          ...
          <span className="bg-gradient-to-b from-white to-zinc-500 bg-clip-text text-transparent uppercase">
            THE DEV HUB.
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="max-w-lg text-zinc-400 text-lg leading-relaxed text-glow-blue mb-10 font-medium italic"
        >
        ...
        >
          <Link href="/vault">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 px-8 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 font-black text-sm tracking-wider shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-all cursor-pointer uppercase"
            >
          ...
          <Link href="/chat">
            <motion.button
              whileHover={{ scale: 1.04 }}
              whileTap={{ scale: 0.97 }}
              className="flex items-center gap-2 px-8 py-3 rounded-xl bg-zinc-900 border border-zinc-700 hover:border-zinc-500 font-black text-sm tracking-wider transition-all cursor-pointer uppercase"
            >
      ...
      >
        <BentoCard href="/vault" id="bento-vault" className="md:col-span-2 min-h-[240px] flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-2xl font-black tracking-tight mb-1 uppercase">Encrypted Vault</h2>
          ...
          <div className="flex items-center gap-2 text-blue-400 text-[10px] font-black tracking-widest mt-6 group-hover:gap-3 transition-all uppercase">
        ...
        <BentoCard href="/chat" id="bento-chat" className="flex flex-col justify-between min-h-[240px]">
          <div>
            ...
            <h2 className="text-2xl font-black tracking-tight mb-1 uppercase">Dev Chat</h2>
            <p className="text-zinc-500 text-sm leading-relaxed font-medium">
              E2E encrypted channels. No logs. No leaks.
            </p>
          </div>
          <div className="flex items-center gap-2 text-indigo-400 text-[10px] font-black tracking-widest mt-6 group-hover:gap-3 transition-all uppercase">
            Enter Chat <ArrowRight size={14} />
          </div>
        </BentoCard>

        <BentoCard id="bento-stats" className="flex flex-col gap-4">
          <div className="flex items-center gap-2 text-zinc-400 text-[10px] font-black tracking-widest uppercase mb-1">
        ...
        <BentoCard id="bento-oss" className="flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-xl font-black tracking-tight mb-1 uppercase">Open Source</h2>
            <p className="text-zinc-500 text-sm font-medium">Built in public. Fork it.</p>
          </div>
          <div className="flex items-center gap-2 text-emerald-400 text-[10px] font-black tracking-widest mt-6 group-hover:gap-3 transition-all uppercase">
        ...
        <BentoCard id="bento-team" className="flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-xl font-black tracking-tight mb-1 uppercase">Elite Access</h2>
            <p className="text-zinc-500 text-sm font-medium">Invite-only dev teams. Role-based perms.</p>
          </div>
          <div className="flex items-center gap-2 text-violet-400 text-[10px] font-black tracking-widest mt-6 group-hover:gap-3 transition-all uppercase">
        ...
        <BentoCard id="bento-security" className="md:col-span-3 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-black text-sm uppercase">Enterprise-Grade Security</p>
              <p className="text-zinc-500 text-xs font-mono">AES-256-GCM · Zero-knowledge · SHA-256 integrity</p>
            </div>
          </div>
          <div className="flex gap-6 text-[9px] font-black tracking-[0.2em] text-zinc-600 uppercase font-mono">
            <span>SOC 2</span>
            <span>GDPR</span>
